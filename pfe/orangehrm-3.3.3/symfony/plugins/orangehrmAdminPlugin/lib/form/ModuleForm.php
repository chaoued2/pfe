...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'indicators' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
        ));        
        ...
        $this->setValidators(array(
            ...
            'indicators' => new sfValidatorPass()
        ));
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'recruitment', 'performance', 'indicators');
